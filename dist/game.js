...
export class SpanielSmashGame {
    ...
    currentSpawnIntervalMs() {
        const baselineSpawnInterval = Math.max(SpanielSmashGame.minSpawnIntervalMs, SpanielSmashGame.levelOneBaseSpawnIntervalMs - (this.speedLevel - 1) * SpanielSmashGame.spawnIntervalLevelStepMs);
    ...
    render(snapshot) {
        ...
        for (const entity of snapshot.entities) {
            if (entity.type === "puddle-patch") {
                ...
                drawSkier(this.ctx, entity.x, entity.y, "#3a86ff", "#ff6b6b");
            else if (entity.type === "spaniel")
                drawSpaniel(this.ctx, entity.x, entity.y, snapshot.sideObstacleOffsetY + entity.x);
...
function drawSpaniel(ctx, x, y, animationSeed = 0) {
