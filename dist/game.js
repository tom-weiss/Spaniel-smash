...
export class SpanielSmashGame {
    ...
    isMovingObstacle(entity) { return entity.type === "skier" || entity.type === "spaniel" || entity.type === "helicopter-downdraft"; }
