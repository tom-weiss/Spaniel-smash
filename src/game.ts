...
export class SpanielSmashGame {
  ...
  private static readonly wetPaintSlipDurationMs = 1400;
  ...
  private tickPlayerEffectTimers(deltaMs: number): void {
  ...
  private isMovingObstacle(entity: Entity): boolean {
    return entity.type === "skier" || entity.type === "spaniel" || entity.type === "andy" || entity.type === "helicopter-downdraft";
  }
