...
Core rendering/audio was refreshed again in `v1.1.17`: trees now read as pointed layered conifers, skier/player sprites keep the narrower silhouette with longer dark downhill-angled skis and longer simplified black poles, the player now wears a red ski jacket, and the soundtrack switches to a faster, more intense boss motif while Andy is active; spaniels still wag their tails and poo-bag splat effects remain brown. Gameplay rules are unchanged.
